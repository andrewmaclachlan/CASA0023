...
Train and classify....we need to get some training data....so select some points or reuse / add to your points from the mixture classification. Note, that if you only have 1 point per landcover class the classifcation will be very poor!
