...
-   Introductory Digital Image Processing: A Remote Sensing Perspective, Jensen (2015). Available as a physical copy or [online via the UCL library](https://app.kortext.com/Shibboleth.sso/Login?entityID=https://shib-idp.ucl.ac.uk/shibboleth&target=https://app.kortext.com/borrow/1872407)
...
| 5 | Temperature and policy | [`r fa("person-chalkboard")`](https://andrewmaclachlan.github.io/CASA0023-lecture-8/#1) | Presentation / learning diary review | `r fa("code")` |
|  | **Reading week** |  |  |  |
| 6 | An introduction to Google Earth Engine | [`r fa("person-chalkboard")`](https://andrewmaclachlan.github.io/CASA0023-lecture-5/#1) | Google Earth Engine | [`r fa("code")`](https://andrewmaclachlan.github.io/CASA0023/5_GEE_I.html) |
| 7 | Classification | [`r fa("person-chalkboard")`](https://andrewmaclachlan.github.io/CASA0023-lecture-6/#1) | Classification I | [`r fa("code")`](https://andrewmaclachlan.github.io/CASA0023/6_classification_I.html) |
| 8 | Classification the big questions (lecture 6 continued) and accuracy | [`r fa("person-chalkboard")`](https://andrewmaclachlan.github.io/CASA0023-lecture-7/#1) | Classification II | [`r fa("code")`](https://andrewmaclachlan.github.io/CASA0023/7_classification_II.html) |
| 9 | SAR in GEE | [`r fa("person-chalkboard")`](https://andrewmaclachlan.github.io/CASA0023-lecture-9/#1) | Temperature or SAR | [`r  fa("temperature-high")`](https://andrewmaclachlan.github.io/CASA0023/8_temperature.html) [`r fa("satellite-dish")`](https://bellingcat.github.io/RS4OSINT/C3_Blast.html) |
