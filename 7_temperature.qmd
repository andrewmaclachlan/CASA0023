...
Later on we will compute temperature from the Landsat data, whilst i refer to and explain each variable created don't get overwhelmed by it, take away the process of loading and manipulating raster data in R to extract meaningful information. 
