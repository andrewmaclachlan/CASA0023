...
```{r echo=FALSE, out.width = "900pt", fig.align='center', cache=TRUE, fig.cap="GEE screen: [GEE community Beginner's Cookbook, TC25](https://developers.google.com/earth-engine/tutorials/community/beginners-cookbook)"}
...
For the task this week select a metropolitan area of your choice (e.g. using [GADM](https://gadm.org/) or another admin boundary dataset) and apply a formula / function that we have seen in the module (or from online / literature) to a collection of data.
...
* Share your code in your portfolio
