...
From this BBC article it says that:
...
https://gis.stackexchange.com/questions/392533/google-earth-engine-calculate-percentile-rank-in-ee-imagecollection

## Guidance

* You should select an area that isn't too cloudly or change the image date seach values
